module.exports.sign_up = ({link}) =>
  `<!DOCTYPE html>
    ...
    <body>
        ...
        <p>Kindly click on this link to complete your registration</p>
        <p class="text"><a href="${link}"><button styles="padding:2em;background-color:blue;">click Me</button></a></p>
        </div>
    
     
        <div>
            <span>
                Hi there!, Welcome on board, kindly use this OTP pin to complete your verification process.
            </span>
            <br>
            <span>
